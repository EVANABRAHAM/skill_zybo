...
export default function ShoeCard3() {
  ...
  return (
    ...
    >
      {/* Purple Circle - Theme Color #840D91 */}
      <div
        ref={circleRef}
        className="absolute top-[-170px] left-[-10px] w-[384px] h-[384px] bg-[#840D91] rounded-full z-[1]"
      />
      ...
      >
        ...
        <div ref={colorRef} className="hidden flex-row items-center gap-2 opacity-0">
          ...
          {/* Green */}
          <div className="w-[16px] h-[16px] rounded-full bg-[#9ADA2A] cursor-pointer ring-2 ring-transparent hover:ring-white transition-all"></div>
          {/* Purple (Selected) */}
          <div className="w-[16px] h-[16px] rounded-full bg-[#840D91] cursor-pointer ring-2 ring-white transition-all"></div>
          {/* Red */}
