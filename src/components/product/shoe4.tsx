...
export default function ShoeCard4() {
    ...
    >
      ...
      >
        ...
        <div ref={colorRef} className="hidden flex-row items-center gap-2 opacity-0">
          ...
          {/* Pink (Selected - using #DB8CAE) */}
          <div className="w-[16px] h-[16px] rounded-full bg-[#DB8CAE] cursor-pointer ring-2 ring-white transition-all"></div>
          {/* Red */}
